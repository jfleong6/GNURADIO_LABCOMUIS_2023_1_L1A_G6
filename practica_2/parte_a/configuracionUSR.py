...
# Title: Configuracionusr
# Author: david_mosquera_2184214/freddy_
...
class configuracionUSR(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Configuracionusr", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Configuracionusr")
        ...
        self.settings = Qt.QSettings("GNU Radio", "configuracionUSR")
        ...
        self._fc_range = Range(50000000, 2200000000, 1000000, 160000000, 200)
        ...
        self._A_range = Range(0, 1, 0.000100, 0.0625, 200)
...
def main(top_block_cls=configuracionUSR, options=None):
